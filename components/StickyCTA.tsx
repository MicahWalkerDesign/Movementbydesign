...
export default function StickyCTA() {
  ...
  return (
    <div className="sticky-cta">
      <div className="mx-3 mb-3 rounded-2xl border border-soft-border dark:border-slate-700 bg-warm-white/95 dark:bg-slate-900/95 backdrop-blur shadow-lift p-2 flex items-center gap-2">
        <Link
        ...
        {wa && (
          <a
            ...
            className="grid place-items-center w-12 h-12 rounded-xl border border-soft-border dark:border-slate-700 text-deep-navy dark:text-slate-300 bg-warm-white dark:bg-slate-800 hover:bg-sand dark:hover:bg-slate-700 transition-colors"
          >
